...
if user_chosen_num <= 99 or user_number_prompt1 > 0:
...
user_age_prompt2 = int(2019 - user_age_prompt1)

# print a message of the users age and what year they were born in
print(str(user_age_prompt1) + " " + "that means you were born in" + " " + str(user_age_prompt2))
